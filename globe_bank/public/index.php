    ...
    <div id="main">
      ...
      <div id="page">
        ...
        if (isset($page)){
          ...
          $allowed_tags='<div><strong><p><li><h1><h2><br><em><ul><img>';
          echo strip_tags($page['content'], $allowed_tags);
        }else{
          // show the homepage
          // The homepage content could be:
          //* be static content (here or in shared file)
          //* the first page from nav_pages
          //* be in the database but write code to hide in the nav
